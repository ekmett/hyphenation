-----------------------------------------------------------------------------
-- |
-- Module      :  Text.Hyphenation.English
...
hyphenateEnglish = hyphenate toLower (unsafePerformIO (readPatterns =<< getDataFileName "en.hyp"))

builtinHyphenateEnglish :: String -> [String]
builtinHyphenateEnglish = hyphenate toLower defaultPatterns

defaultPatterns :: [String]
defaultPatterns = knuthLiangPatterns ++ extraPatterns ++ exceptionPatterns
...
-- | Manually constructed exceptions for words that otherwise break the rules
exceptionPatterns :: [String]
exceptionPatterns =
  [".a8s9s8o9c8i8a8t8e.", ".a8s9s8o9c8i8a8t8e8s.",".d8e8c9l8i9n8a9t8i8o8n.",".o8b8l8i8g9a9t8o8r8y."
  ,".p8h8i8l9a8n9t8h8r8o8p8i8c.",".p8r8e8s8e8n8t.",".p8r8e8s8e8n8t8s.", ".p8r8o8j8e8c8t.", ".p8r8o8j8e8c8t8s."
  ,".r8e8c8i9p8r8o8c8i8t8y.",".r8e9c8o8g9n8i9z8a8n8c8e.",".r8e8f9o8r9m8a9t8i8o8n.",".r8e8t9r8i9b8u9t8i8o8n."
  ,".t8a9b8l8e."
  ]
